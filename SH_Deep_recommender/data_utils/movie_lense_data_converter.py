...
def main():
  inpt = "C:\\Users\msi\Desktop\Soohyun\CHALLENGERS\DATASET\MovieLens\\ratings.csv"
  out_prefix = "C:\\Users\msi\PycharmProjects\Deeplearning\DeepRecommender\MovieLens\\movielens"
  percent = 0.7
  user2id_map = dict()
  item2id_map = dict()
  userId = 0
  ...
  save_data_to_file(training_data, out_prefix+".train.txt")
  print("Validation Data")
  print_stats(validation_data)
  save_data_to_file(validation_data, out_prefix + ".valid.txt")
  print("Test Data")
  print_stats(test_data)
  save_data_to_file(test_data, out_prefix + ".test.txt")
